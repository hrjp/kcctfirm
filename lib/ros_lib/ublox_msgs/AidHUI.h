...
namespace ublox_msgs
{
  ...
  class AidHUI : public ros::Msg
  {
    public:
      ...
      _health_type health;
      typedef float _utcA0_type;
      _utcA0_type utcA0;
      typedef float _utcA1_type;
      _utcA1_type utcA1;
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 3) = (this->health >> (8 * 3)) & 0xFF;
      ...
      offset += serializeAvrFloat64(outbuffer + offset, this->utcA0);
      offset += serializeAvrFloat64(outbuffer + offset, this->utcA1);
      union {
        int32_t real;
        uint32_t base;
      } u_utcTOW;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      offset += sizeof(this->health);
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->utcA0));
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->utcA1));
      union {
        int32_t real;
        uint32_t base;
      } u_utcTOW;
    ...
    const char * getType(){ return "ublox_msgs/AidHUI"; };
    const char * getMD5(){ return "60cd4ce940333cb9b38edd447085ce5c"; };
