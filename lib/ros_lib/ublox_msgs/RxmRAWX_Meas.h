...
namespace ublox_msgs
{
  ...
  {
    public:
      typedef float _prMes_type;
      _prMes_type prMes;
      typedef float _cpMes_type;
      _cpMes_type cpMes;
    ...
    {
      int offset = 0;
      offset += serializeAvrFloat64(outbuffer + offset, this->prMes);
      offset += serializeAvrFloat64(outbuffer + offset, this->cpMes);
      union {
        float real;
        uint32_t base;
      } u_doMes;
    ...
    {
      int offset = 0;
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->prMes));
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->cpMes));
      union {
        float real;
        uint32_t base;
      } u_doMes;
    ...
    const char * getType(){ return "ublox_msgs/RxmRAWX_Meas"; };
    const char * getMD5(){ return "d6a580262875bf83a377ba14dcdd659f"; };
