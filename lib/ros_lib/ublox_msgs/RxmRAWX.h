...
namespace ublox_msgs
{
  ...
  class RxmRAWX : public ros::Msg
  {
    ...
    {
      int offset = 0;
      offset += serializeAvrFloat64(outbuffer + offset, this->rcvTOW);
    ...
    {
      int offset = 0;
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->rcvTOW));
    ...
    const char * getType(){ return "ublox_msgs/RxmRAWX"; };
    const char * getMD5(){ return "a2df4b27b6a2a1565e42f5669dbb11b5"; };
